...
def main():
    """
    Only do triple quotes with double quotes :)
    Shows basic usage of Google Calendar API
    Print the start and name of 10 events on the user's calendar.
    """
    creds = None
    ...
    # If there are not (valid) credentials available, let the user log in.
